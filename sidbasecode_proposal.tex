...
\caption{In 1982 33 unique transitions, 47\% of all transitions are simply enabling/disabling the triangle waveform, the TEST bit is only used in isolation.}
\label{c1982}
\end{figure*}

\begin{figure*}
\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{1983}}
\caption{1983: 165 unique transitions, 55\% of all transitions involve using each single waveform possibility in isolation, < 1\% use the TEST bit in combination with a waveform.}
\label{c1983}
\end{figure*}

\begin{figure*}
\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{1984}}
\caption{1984: 305 unique transitions, 42\% of all transitions involve the pulse waveform in isolation, > 10\% use TEST bit with combinations of waveforms.}
\label{c1984}
\end{figure*}
