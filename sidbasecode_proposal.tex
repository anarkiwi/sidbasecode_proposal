...
The Commodore 64, introduced in the early 1980s combined a simple synthesizer (the SID chip) with an accessible and low cost computer. This combination laid down the technical and creative challenge of realizing new sonic capabilities despite the limitations of the computer. This challenge continues to be answered today through creative, ongoing competitions within an informal international community known as the Demoscene. The Demoscene has been included in the German UNESCO Commission's Nationwide Inventory of Intangible Cultural Heritage\cite{heritage}.
...
There are existing tools for musicological analysis such as Music21\cite{music21} which enables high level score analysis and comparison of composition features such as key transitions and beat signatures. There are also tools for extracting sonic features from music such as torchaudio\cite{hwang2023torchaudio}, such as the Mel-frequency cepstrum which can be used for machine learning based audio similarity analysis. The proposed research goes beyond this level of detail to focus on expression, and will produce new tools that operate at a patch/waveform/microsecond (MHz) level rather than a more human-centric note/bar/measure level or even audio sample (kHz) level.
...
\begin{figure*}
\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{1982}}
\caption{1982}
\end{figure*}

\begin{figure*}
\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{1983}}
\caption{1983}
\end{figure*}

\begin{figure*}
\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{1984}}
\caption{1984}
\end{figure*}
