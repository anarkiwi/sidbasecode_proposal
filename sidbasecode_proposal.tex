...
The Commodore 64 introduced in the early 1980’s combined a simple synthesizer (the SID chip) with an accessible and low cost computer. This combination laid down the technical and creative challenge of realizing new sonic capabilities despite the limitations of the computer through creative competition within an informal international community known as the Demoscene, which continues to this day.
...
The NES (Nintendo Entertainment system)platform, like the SID chip, had multiple waveforms and voices, but no filters, though has been the subject of some musicological research\cite{nesmusic}. For these reasons expressive complexity on these other platforms is limited and so they are not part of proposed research.
